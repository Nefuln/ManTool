...
fileprivate extension UIDevice {
    var platfromList: [MTDeviceModel] {
        ...
        let iPhone1_1 = MTPhoneModel(platform: "iPhone1,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 1G", phoneType: .iPhone1G)
        let iPhone1_2 = MTPhoneModel(platform: "iPhone1,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 3G", phoneType: .iPhone3G)
        let iPhone2_1 = MTPhoneModel(platform: "iPhone2,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 3GS", phoneType: .iPhone3GS)
        let iPhone3_1 = MTPhoneModel(platform: "iPhone3,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 4", phoneType: .iPhone4)
        let iPhone3_2 = MTPhoneModel(platform: "iPhone3,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 4", phoneType: .iPhone4)
        let iPhone4_1 = MTPhoneModel(platform: "iPhone4,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 4S", phoneType: .iPhone4S)
        let iPhone5_1 = MTPhoneModel(platform: "iPhone5,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 5", phoneType: .iPhone5)
        let iPhone5_2 = MTPhoneModel(platform: "iPhone5,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 5", phoneType: .iPhone5)
        let iPhone5_3 = MTPhoneModel(platform: "iPhone5,3", deviceType: MTDeviceType.iPadMini, desc: "iPhone 5C", phoneType: .iPhone5C)
        let iPhone5_4 = MTPhoneModel(platform: "iPhone5,4", deviceType: MTDeviceType.iPadMini, desc: "iPhone 5C", phoneType: .iPhone5C)
        let iPhone6_1 = MTPhoneModel(platform: "iPhone6,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 5S", phoneType: .iPhone5S)
        let iPhone6_2 = MTPhoneModel(platform: "iPhone6,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 5S", phoneType: .iPhone5S)
        let iPhone7_1 = MTPhoneModel(platform: "iPhone7,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 6 Plus", phoneType: .iPhone6Plus)
        let iPhone7_2 = MTPhoneModel(platform: "iPhone7,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 6", phoneType: .iPhone6)
        let iPhone8_1 = MTPhoneModel(platform: "iPhone8,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 6s", phoneType: .iPhone6S)
        let iPhone8_2 = MTPhoneModel(platform: "iPhone8,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 6s Plus", phoneType: .iPhone6SPlus)
        let iPhone8_4 = MTPhoneModel(platform: "iPhone8,4", deviceType: MTDeviceType.iPadMini, desc: "iPhone SE", phoneType: .iPhoneSE)
        let iPhone9_1 = MTPhoneModel(platform: "iPhone9,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 7", phoneType: .iPhone7)
        let iPhone9_3 = MTPhoneModel(platform: "iPhone9,3", deviceType: MTDeviceType.iPadMini, desc: "iPhone 7", phoneType: .iPhone7)
        let iPhone9_2 = MTPhoneModel(platform: "iPhone9,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 7 Plus", phoneType: .iPhone7Plus)
        let iPhone9_4 = MTPhoneModel(platform: "iPhone9,4", deviceType: MTDeviceType.iPadMini, desc: "iPhone 7 Plus", phoneType: .iPhone7Plus)
        let iPhone10_1 = MTPhoneModel(platform: "iPhone10,1", deviceType: MTDeviceType.iPadMini, desc: "iPhone 8", phoneType: .iPhone8)
        let iPhone10_4 = MTPhoneModel(platform: "iPhone10,4", deviceType: MTDeviceType.iPadMini, desc: "iPhone 8", phoneType: .iPhone8)
        let iPhone10_2 = MTPhoneModel(platform: "iPhone10,2", deviceType: MTDeviceType.iPadMini, desc: "iPhone 8 Plus", phoneType: .iPhone8Plus)
        let iPhone10_5 = MTPhoneModel(platform: "iPhone10,5", deviceType: MTDeviceType.iPadMini, desc: "iPhone 8 Plus", phoneType: .iPhone8Plus)
        let iPhone10_3 = MTPhoneModel(platform: "iPhone10,3", deviceType: MTDeviceType.iPadMini, desc: "iPhone X", phoneType: .iPhoneX)
        let iPhone10_6 = MTPhoneModel(platform: "iPhone10_6", deviceType: MTDeviceType.iPadMini, desc: "iPhone X", phoneType: .iPhoneX)

        let iPod1_1 = MTDeviceModel(platform: "iPod1,1", deviceType: MTDeviceType.iPadMini, desc: "iPod touch")
        let iPod2_1 = MTDeviceModel(platform: "iPod2,1", deviceType: MTDeviceType.iPadMini, desc: "iPod touch (2nd generation)")
        let iPod3_1 = MTDeviceModel(platform: "iPod3,1", deviceType: MTDeviceType.iPadMini, desc: "iPod touch (3rd generation)")
        let iPod4_1 = MTDeviceModel(platform: "iPod4,1", deviceType: MTDeviceType.iPadMini, desc: "iPod touch (4th generation)")
        let iPod5_1 = MTDeviceModel(platform: "iPod5,1", deviceType: MTDeviceType.iPadMini, desc: "iPod touch (5th generation)")
        let iPod7_1 = MTDeviceModel(platform: "iPod7,1", deviceType: MTDeviceType.iPadMini, desc: "iPod touch (6th generation)")
